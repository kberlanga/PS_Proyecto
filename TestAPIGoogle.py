...
class MockTest(unittest.TestCase):
    ...
    def testGetBook(self):
        ...
        Book("I've Got the Light of Freedom", 'The Organizing Tradition and the Mississippi Freedom Struggle', ['Charles M. Payne'], 'Univ of California Press', '1995', 'Traces the history of the civil rights movement in Mississippi, and describes how ordinary men and women became caught up in the struggle', '0520251768', 525, ['History'],
